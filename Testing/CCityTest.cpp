...
namespace Testing
{
	...
	public:
		...
		TEST_METHOD(TestCCityVisitor)
		{
			...
			// Test doesn't call on empty city
			...
			city.Accept(&visitor);
			Assert::AreEqual(1, visitor.mNumBuildings, L"Visitor nmber of buildings");
			Assert::AreEqual(1, visitor.mNumCoalmines, L"Visitor nmber of coal mines");
			Assert::AreEqual(1, visitor.mNumLandscapes, L"Visitor nmber of landscapes");
			Assert::AreEqual(1, visitor.mNumRoads, L"Visitor nmber of roads");
		}
